...
interface ExpectBuilder {
    ...
    interface OptionsChooser {
        ...
        /**
         * Wraps the given [representation] into an [Untranslatable] and passes it to the overload
         * which expects a [Translatable] -- this is then used as custom representation for `null`.
         */
        fun withNullRepresentation(representation: String) {
            withNullRepresentation(Untranslatable(representation))
        }

        /**
         * Use the given [representation] as custom representation for `null`.
         */
        fun withNullRepresentation(representation: Translatable)
